...
export const HomeApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async homeControllerAppInfo(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await HomeApiAxiosParamCreator(configuration).homeControllerAppInfo(options);
...
export const HomeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async homeControllerAppInfo(options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return HomeApiFp(configuration).homeControllerAppInfo(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class HomeApi extends BaseAPI {
     ...
     * @memberof HomeApi
     */
    public async homeControllerAppInfo(options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
